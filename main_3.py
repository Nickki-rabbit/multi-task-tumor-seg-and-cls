# only the savedir of result has changed: 448-->224
# #2: remove the previous 20 wavelength = noise
...
def trainValidateSegmentation(args):
    ...
    if not os.path.isfile(args.cached_data_file):
        ...
        if dataLoader == None:
            ...
            exit(-1)
        p_data, p_gt, p_cls, data_dict = dataLoader.processData()
    else:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--savedir', default='./results_ynet_remove20', help='results directory')
